...
@endif
                    ...
                    <li class="divider-vertical"></li>
@if(in_array(Request::route()->action['as'], array('account','login', 'profile', 'editprofile', 'address', 'editaddress', 'orders', 'orderhistory', 'register', 'deleteprofile', 'manage_orders', 'manage_products', 'manage_users', 'manage_categories')))
                    <li class="active">
@else
                    <li>
@endif
