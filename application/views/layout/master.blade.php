            ...
            <div class="navbar-inner">
              <div class="container">
                <div class="nav-collapse">
                  <ul class="nav">
                    <li class="active"><a href="{{ URL::to_route('shop') }}"><i class="icon-home icon-white"></i> {{ __('rhine/nav.shop') }}</a></li>
                    <li class="divider-vertical"></li>
                    <li><a href="{{ URL::to_route('cart') }}"><i class="icon-shopping-cart icon-white"></i> {{ __('rhine/nav.cart') }}</a></li>
                    <li class="divider-vertical"></li>
                    <li><a href="{{ URL::to_route('account') }}"><i class="icon-user icon-white"></i> {{ __('rhine/nav.myaccount') }}</a></li>
                    <li class="divider-vertical"></li>
                    <li><a href="{{ URL::to_route('information') }}"><i class="icon-info-sign icon-white"></i> {{ __('rhine/nav.information') }}</a></li>
                  </ul>
